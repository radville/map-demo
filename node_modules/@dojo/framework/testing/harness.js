(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "tslib", "./support/assertRender", "./support/selector"], factory);
    }
    ...
    function harness(renderFunc, customComparator) {
        ...
        function _tryRender() {
            ...
            if (invalidated) {
                ...
                var _b = selector_1.decorateNodes(render), hasDeferredProperties = _b.hasDeferredProperties, nodes = _b.nodes;
                _runCompares(nodes);
