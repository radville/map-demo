(function (factory) {
     ...
     */
    exports.WNODE = '__WNODE_TYPE';
    /**
     * The identifier for a VNode type
     */
    exports.VNODE = '__VNODE_TYPE';
    /**
     * The identifier for a VNode type created using dom()
     */
    exports.DOMVNODE = '__DOMVNODE_TYPE';
    /**
     * Helper function that returns true if the `DNode` is a `WNode` using the `type` property
     */
    function isWNode(child) {
        return Boolean(child && child !== true && typeof child !== 'string' && child.type === exports.WNODE);
    }
    ...
    function isVNode(child) {
        return Boolean(child && child !== true && typeof child !== 'string' && (child.type === exports.VNODE || child.type === exports.DOMVNODE));
    }
    ...
    function isDomVNode(child) {
        return Boolean(child && child !== true && typeof child !== 'string' && child.type === exports.DOMVNODE);
    }
