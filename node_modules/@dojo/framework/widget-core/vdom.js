(function (factory) {
    ...
    function createClassPropValue(classes) {
        ...
        return classes
            .filter(function (className) { return className && className !== true; })
            .join(' ')
            .trim();
    }
    ...
    function runExitAnimation(current, transitions, exitAnimation) {
        var domNode = current.domNode, properties = current.node.properties;
    ...
    function renderer(renderer) {
        ...
        function _runDomInstructionQueue() {
            ...
            while ((item = _applicationQueue.pop())) {
                if (item.type === 'create') {
                    ...
                    var exitAnimation = current.node.properties.exitAnimation;
        ...
        function setDomNodeOnParentWrapper(next) {
            ...
            while (parentWNodeWrapper && !parentWNodeWrapper.domNode) {
                ...
                var nextParent = _parentWrapperMap.get(parentWNodeWrapper);
